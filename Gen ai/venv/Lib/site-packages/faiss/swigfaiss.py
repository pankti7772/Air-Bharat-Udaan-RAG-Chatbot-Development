...
class IndexHNSWFlatPanorama(IndexHNSWFlat):
    ...
    def compute_cum_sums(x, dst_cum_sums, d, num_panorama_levels, panorama_level_width):
        ...
        queries).
        """
        return _swigfaiss.IndexHNSWFlatPanorama_compute_cum_sums(x, dst_cum_sums, d, num_panorama_levels, panorama_level_width)
    cum_sums = property(_swigfaiss.IndexHNSWFlatPanorama_cum_sums_get, _swigfaiss.IndexHNSWFlatPanorama_cum_sums_set)
    panorama_level_width = property(_swigfaiss.IndexHNSWFlatPanorama_panorama_level_width_get)
